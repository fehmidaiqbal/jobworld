...
from jobworld_djp_api.views import CUqualif_info, Skill, create__personal_info, get_area_info, get_branches, get_city_info, get_courses, get_coursetypes, get_personal_info, get_qualif_info, get_state_info, get_userskill, login_user, register_user, skill
